...
{
    public class DashboardOldBase : ComponentBase
    {
        [Inject]
        public NavigationManager NavigationManager { get; set; }

        [Inject]
        public IOldChartDataService OldChartDataService { get; set; }
                        ...
                        YAxes = new List<CartesianAxis>
{
            ...
            try
            {
                ...
                var invitesSentAndConverted = await OldChartDataService.GetInvitesSentAndConvertedSequence(_brokerId);
                ...
                var totalLogins = await OldChartDataService.GetTotalLogins(_brokerId);
                ...
                var totals = await this.OldChartDataService.GetInvitesSentAndConverted(_brokerId);
