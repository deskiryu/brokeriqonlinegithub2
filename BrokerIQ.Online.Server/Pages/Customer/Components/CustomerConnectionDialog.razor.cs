    ...
    public partial class CustomerConnectionDialog : ComponentBase
    {
        ...
        private async Task ConnectToCustomer()
        {
            var parameters = new DialogParameters
            {
                ...
                { "AdditionalText", $"ALL THE DATA FOR {SelectedCustomer.FirstName} {SelectedCustomer.LastName} WILL BECOME UNAVAILABLE! Please ensure any UPLOADS from this customer have been processed. They will dissappear after this connection is made." },
                { "ButtonText", "Connect" },
                { "Color", Color.Error }
            };
